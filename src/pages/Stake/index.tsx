        ...
        <main className="relative flex-1 py-8">
          ...
          <section className="relative mt-8 overflow-hidden">
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-zinc-300">
              here is the full list of projects that accept PUMPKIN as a utility token : <a style={{ color: "blue" }} href={"https://www.pumpkin.financial/our-projects"}>https://www.pumpkin.financial/our-projects</a>
            </p>
          </section>
        </main>
      </div>
